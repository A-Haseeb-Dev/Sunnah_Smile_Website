      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full lg:flex-1 text-center lg:text-left z-10 hero-content">
            <div className="hero-animate inline-flex items-center space-x-2 bg-primary/5 px-4 py-2 rounded-full mb-6 border border-primary/10">
            ...
            <h1 className="hero-animate text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-playfair font-bold text-primary leading-tight mb-6">
              Revive the Sunnah. <br className="hidden sm:block" />
              <span className="text-cta">Protect Your Smile Naturally.</span>
            </h1>
            <p className="hero-animate text-base md:text-lg lg:text-xl text-primary/80 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Miswak-powered toothbrush for healthier teeth & a cleaner planet. Join thousands of families choosing faith-driven hygiene.
            </p>

            {/* Product Image Highlight - Optimized for mobile/portrait */}
            <div className="hero-animate relative mb-12 lg:mb-0 group max-w-sm sm:max-w-md mx-auto lg:mx-0 px-4">
            ...
            <div className="hero-animate flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 mb-10 mt-10 md:mt-12">
              <div className="flex items-center space-x-2 bg-white px-3 sm:px-4 py-2 rounded-lg shadow-sm border border-primary/10 hover:border-cta transition-colors cursor-default whitespace-nowrap">
                <i className="fa-solid fa-moon text-accent text-sm"></i>
                <span className="text-xs sm:text-sm font-semibold">Sunnah-based</span>
              </div>
              <div className="flex items-center space-x-2 bg-white px-3 sm:px-4 py-2 rounded-lg shadow-sm border border-primary/10 hover:border-cta transition-colors cursor-default whitespace-nowrap">
                <i className="fa-solid fa-leaf text-cta text-sm"></i>
              ...
              <div className="flex items-center space-x-2 bg-white px-3 sm:px-4 py-2 rounded-lg shadow-sm border border-primary/10 hover:border-cta transition-colors cursor-default whitespace-nowrap">
                ...
                <span className="text-xs sm:text-sm font-semibold">COD Available</span>
              </div>
            </div>
          </div>

          {/* POS Form Right */}
          <div className="w-full lg:w-[400px] xl:w-[420px] z-10 hero-form">
